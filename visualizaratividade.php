...
<head>
    <link rel="stylesheet" href="/Estilos/estilos.css"> <!-- Correção do caminho para o arquivo CSS -->
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="content">
        ...
        <a href="inicio.php"> Voltar a lista de atividade</a>
        <a href="cadastroatividades.php"> Cadastrar nova atividade</a> 
